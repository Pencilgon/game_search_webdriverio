Feature: Itch.io Game Search and Purchase
  ...
  Scenario: Game search validation
    ...
    And The header contains the search query
    ...
    When I expand the More information section in the game page
    ...
    Then The search results page is displayed
    And The 1 game should match the initial search result
  ...
  Scenario: Game price validation
    ...
    When I open the 1 game from the search results
    Then The game page is displayed
    And The game price matches with the price shown on the search results page

    When I click the Buy button
    Then The purchase form is displayed
    And The game price matches with the price shown on the game page
